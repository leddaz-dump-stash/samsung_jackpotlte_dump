...
# Bootloader
TARGET_BOOTLOADER_BOARD_NAME := SRPQH21C020RU

# File systems
BOARD_HAS_LARGE_FILESYSTEM := true
#BOARD_RECOVERYIMAGE_PARTITION_SIZE := 34507040 # This is the maximum known partition size, but it can be higher, so we just omit it
